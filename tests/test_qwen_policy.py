...
class QwenPolicyTests(unittest.TestCase):
    ...
    def test_shopping_admin_dashboard_prefers_dashboard_rows_when_bestseller_goal_has_no_time_scope(self) -> None:
        observation = NormalizedObservation(
            goal="What are the top-2 best-selling product",
            current_url="http://16.58.174.55:7780/admin/admin/dashboard/",
            open_tabs=[
                OpenTab(
                    title="Dashboard / Magento Admin",
    ...
    def test_shopping_admin_dashboard_prefers_aggregate_rows_for_month_specific_bestsellers_without_report_rows(self) -> None:
        observation = NormalizedObservation(
            goal="What are the top-3 best-selling product in Jan 2023",
            current_url="http://3.14.148.71:7780/admin/admin/dashboard/",
            open_tabs=[
            ...
            visible_page_summary=(
                ...
                "Dashboard bestseller row: rank=2 | product=Sprite Stasis Ball 65 cm | price=27.00 | quantity=6\n"
                "Dashboard bestseller row: rank=3 | product=Sprite Yoga Strap 6 foot | price=14.00 | quantity=6\n"
                "Admin bestseller aggregate row: rank=1 | product=Overnight Duffle | quantity=2\n"
        ...
        backend = FakeBackend(['ACTION: fill("Quest Lumaflex", "687")'])
        policy = QwenPolicy(backend=backend, config=self.config)
    ...
    def test_shopping_admin_dashboard_prefers_aggregate_rows_for_month_specific_product_type_without_report_rows(self) -> None:
        observation = NormalizedObservation(
            goal="What is the top-1 best-selling product type in Jan 2023",
            current_url="http://3.14.148.71:7780/admin/admin/dashboard/",
            open_tabs=[
        ...
        backend = FakeBackend(['ACTION: fill("top-1 best-selling product type in Jan 2023", "687")'])
        policy = QwenPolicy(backend=backend, config=self.config)
