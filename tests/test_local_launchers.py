...
class LocalLaunchersTests(unittest.TestCase):
    ...
    def test_qwen_tmux_launchers_write_tmux_session_metadata(self) -> None:
        ...
        bootstrap41_qlora_gitlabcoverage_cleandemos_warmupoversample_yearproducttiefix_tmux = _read_local_script("run_qwen_bootstrap41_curriculum_qlora_gitlabcoverage_cleandemos_warmupoversample_yearproducttiefix_tmux.sh")
        bootstrap41_qlora_gitlabcoverage_cleandemos_warmupoversample_yearproducttiefix_adminoversample_tmux = _read_local_script("run_qwen_bootstrap41_curriculum_qlora_gitlabcoverage_cleandemos_warmupoversample_yearproducttiefix_adminoversample_tmux.sh")
        ...
        bootstrap44_qlora_gitlabcoverage_cleandemos_warmupoversample_yearfix_tmux = _read_local_script("run_qwen_bootstrap44_curriculum_qlora_gitlabcoverage_cleandemos_warmupoversample_yearfix_tmux.sh")
        bootstrap44_qlora_gitlabcoverage_cleandemos_warmupoversample_yearproducttiefix_tmux = _read_local_script("run_qwen_bootstrap44_curriculum_qlora_gitlabcoverage_cleandemos_warmupoversample_yearproducttiefix_tmux.sh")
        bootstrap44_qlora_gitlabcoverage_cleandemos_warmupoversample_yearproducttiefix_adminoversample_tmux = _read_local_script("run_qwen_bootstrap44_curriculum_qlora_gitlabcoverage_cleandemos_warmupoversample_yearproducttiefix_adminoversample_tmux.sh")
        ...
        web_mix88_qlora_gitlabcoverage_warmupoversample_yearproducttiefix_tmux = _read_local_script("run_qwen_web_mix88_curriculum_qlora_gitlabcoverage_warmupoversample_yearproducttiefix_tmux.sh")
        web_mix88_qlora_gitlabcoverage_warmupoversample_yearproducttiefix_adminoversample_tmux = _read_local_script("run_qwen_web_mix88_curriculum_qlora_gitlabcoverage_warmupoversample_yearproducttiefix_adminoversample_tmux.sh")
        ...
        web_mix91_qlora_gitlabcoverage_warmupoversample_yearfix_tmux = _read_local_script("run_qwen_web_mix91_curriculum_qlora_gitlabcoverage_warmupoversample_yearfix_tmux.sh")
        web_mix91_qlora_gitlabcoverage_warmupoversample_yearproducttiefix_tmux = _read_local_script("run_qwen_web_mix91_curriculum_qlora_gitlabcoverage_warmupoversample_yearproducttiefix_tmux.sh")
        web_mix91_qlora_gitlabcoverage_warmupoversample_yearproducttiefix_adminoversample_tmux = _read_local_script("run_qwen_web_mix91_curriculum_qlora_gitlabcoverage_warmupoversample_yearproducttiefix_adminoversample_tmux.sh")
        ...
        self.assertIn('RUN_OUT_DIR="${RUN_OUT_DIR:-$WORKSPACE_ROOT/outputs/qwen_bootstrap41_curriculum_v22_qlora_gitlabcoverage_cleandemos_warmupoversample_yearproducttiefix}"', bootstrap41_qlora_gitlabcoverage_cleandemos_warmupoversample_yearproducttiefix_tmux)
        self.assertIn('TMUX_SESSION_NAME="${TMUX_SESSION_NAME:-qwen_bootstrap41_v22_qlora_gitlabcoverage_cleandemos_warmupoversample_yearproducttiefix}"', bootstrap41_qlora_gitlabcoverage_cleandemos_warmupoversample_yearproducttiefix_tmux)
        self.assertIn('run_qwen_bootstrap41_curriculum_qlora_gitlabcoverage_cleandemos_warmupoversample_tmux.sh', bootstrap41_qlora_gitlabcoverage_cleandemos_warmupoversample_yearproducttiefix_tmux)

        self.assertIn('RUN_OUT_DIR="${RUN_OUT_DIR:-$WORKSPACE_ROOT/outputs/qwen_bootstrap41_curriculum_v23_qlora_gitlabcoverage_cleandemos_warmupoversample_yearproducttiefix_adminoversample}"', bootstrap41_qlora_gitlabcoverage_cleandemos_warmupoversample_yearproducttiefix_adminoversample_tmux)
        self.assertIn('TMUX_SESSION_NAME="${TMUX_SESSION_NAME:-qwen_bootstrap41_v23_qlora_gitlabcoverage_cleandemos_warmupoversample_yearproducttiefix_adminoversample}"', bootstrap41_qlora_gitlabcoverage_cleandemos_warmupoversample_yearproducttiefix_adminoversample_tmux)
        self.assertIn('--warmup-demo-task-group-episodes site_shopping_admin=4', bootstrap41_qlora_gitlabcoverage_cleandemos_warmupoversample_yearproducttiefix_adminoversample_tmux)
        self.assertIn('--warmup-demo-task-group-limit-per-task site_shopping_admin=4', bootstrap41_qlora_gitlabcoverage_cleandemos_warmupoversample_yearproducttiefix_adminoversample_tmux)
        self.assertIn('--warmup-task-group-sample-multiplier site_shopping_admin=2.0', bootstrap41_qlora_gitlabcoverage_cleandemos_warmupoversample_yearproducttiefix_adminoversample_tmux)
        self.assertIn('run_qwen_bootstrap41_curriculum_qlora_gitlabcoverage_cleandemos_warmupoversample_yearproducttiefix_tmux.sh', bootstrap41_qlora_gitlabcoverage_cleandemos_warmupoversample_yearproducttiefix_adminoversample_tmux)
        ...
        self.assertIn('RUN_OUT_DIR="${RUN_OUT_DIR:-$WORKSPACE_ROOT/outputs/qwen_bootstrap44_curriculum_v3_qlora_gitlabcoverage_cleandemos_warmupoversample_yearfix}"', bootstrap44_qlora_gitlabcoverage_cleandemos_warmupoversample_yearfix_tmux)
        self.assertIn('TMUX_SESSION_NAME="${TMUX_SESSION_NAME:-qwen_bootstrap44_v3_qlora_gitlabcoverage_cleandemos_warmupoversample_yearfix}"', bootstrap44_qlora_gitlabcoverage_cleandemos_warmupoversample_yearfix_tmux)
        self.assertIn('run_qwen_bootstrap44_curriculum_qlora_gitlabcoverage_cleandemos_warmupoversample_tmux.sh', bootstrap44_qlora_gitlabcoverage_cleandemos_warmupoversample_yearfix_tmux)

        self.assertIn('RUN_OUT_DIR="${RUN_OUT_DIR:-$WORKSPACE_ROOT/outputs/qwen_bootstrap44_curriculum_v4_qlora_gitlabcoverage_cleandemos_warmupoversample_yearproducttiefix}"', bootstrap44_qlora_gitlabcoverage_cleandemos_warmupoversample_yearproducttiefix_tmux)
        self.assertIn('TMUX_SESSION_NAME="${TMUX_SESSION_NAME:-qwen_bootstrap44_v4_qlora_gitlabcoverage_cleandemos_warmupoversample_yearproducttiefix}"', bootstrap44_qlora_gitlabcoverage_cleandemos_warmupoversample_yearproducttiefix_tmux)
        self.assertIn('run_qwen_bootstrap44_curriculum_qlora_gitlabcoverage_cleandemos_warmupoversample_tmux.sh', bootstrap44_qlora_gitlabcoverage_cleandemos_warmupoversample_yearproducttiefix_tmux)

        self.assertIn('RUN_OUT_DIR="${RUN_OUT_DIR:-$WORKSPACE_ROOT/outputs/qwen_bootstrap44_curriculum_v5_qlora_gitlabcoverage_cleandemos_warmupoversample_yearproducttiefix_adminoversample}"', bootstrap44_qlora_gitlabcoverage_cleandemos_warmupoversample_yearproducttiefix_adminoversample_tmux)
        self.assertIn('TMUX_SESSION_NAME="${TMUX_SESSION_NAME:-qwen_bootstrap44_v5_qlora_gitlabcoverage_cleandemos_warmupoversample_yearproducttiefix_adminoversample}"', bootstrap44_qlora_gitlabcoverage_cleandemos_warmupoversample_yearproducttiefix_adminoversample_tmux)
        self.assertIn('--warmup-demo-task-group-episodes site_shopping_admin=4', bootstrap44_qlora_gitlabcoverage_cleandemos_warmupoversample_yearproducttiefix_adminoversample_tmux)
        self.assertIn('--warmup-demo-task-group-limit-per-task site_shopping_admin=4', bootstrap44_qlora_gitlabcoverage_cleandemos_warmupoversample_yearproducttiefix_adminoversample_tmux)
        self.assertIn('--warmup-task-group-sample-multiplier site_shopping_admin=2.0', bootstrap44_qlora_gitlabcoverage_cleandemos_warmupoversample_yearproducttiefix_adminoversample_tmux)
        self.assertIn('run_qwen_bootstrap44_curriculum_qlora_gitlabcoverage_cleandemos_warmupoversample_yearproducttiefix_tmux.sh', bootstrap44_qlora_gitlabcoverage_cleandemos_warmupoversample_yearproducttiefix_adminoversample_tmux)
        ...
        self.assertIn('RUN_OUT_DIR="${RUN_OUT_DIR:-$WORKSPACE_ROOT/outputs/qwen_web_mix88_curriculum_v5_qlora_gitlabcoverage_warmupoversample_yearproducttiefix}"', web_mix88_qlora_gitlabcoverage_warmupoversample_yearproducttiefix_tmux)
        self.assertIn('TMUX_SESSION_NAME="${TMUX_SESSION_NAME:-qwen_web_mix88_v5_qlora_gitlabcoverage_warmupoversample_yearproducttiefix}"', web_mix88_qlora_gitlabcoverage_warmupoversample_yearproducttiefix_tmux)
        self.assertIn('run_qwen_web_mix88_curriculum_qlora_gitlabcoverage_warmupoversample_tmux.sh', web_mix88_qlora_gitlabcoverage_warmupoversample_yearproducttiefix_tmux)

        self.assertIn('RUN_OUT_DIR="${RUN_OUT_DIR:-$WORKSPACE_ROOT/outputs/qwen_web_mix88_curriculum_v6_qlora_gitlabcoverage_warmupoversample_yearproducttiefix_adminoversample}"', web_mix88_qlora_gitlabcoverage_warmupoversample_yearproducttiefix_adminoversample_tmux)
        self.assertIn('TMUX_SESSION_NAME="${TMUX_SESSION_NAME:-qwen_web_mix88_v6_qlora_gitlabcoverage_warmupoversample_yearproducttiefix_adminoversample}"', web_mix88_qlora_gitlabcoverage_warmupoversample_yearproducttiefix_adminoversample_tmux)
        self.assertIn('--warmup-demo-task-group-episodes site_shopping_admin=4', web_mix88_qlora_gitlabcoverage_warmupoversample_yearproducttiefix_adminoversample_tmux)
        self.assertIn('--warmup-demo-task-group-limit-per-task site_shopping_admin=4', web_mix88_qlora_gitlabcoverage_warmupoversample_yearproducttiefix_adminoversample_tmux)
        self.assertIn('--warmup-task-group-sample-multiplier site_shopping_admin=2.0', web_mix88_qlora_gitlabcoverage_warmupoversample_yearproducttiefix_adminoversample_tmux)
        self.assertIn('run_qwen_web_mix88_curriculum_qlora_gitlabcoverage_warmupoversample_yearproducttiefix_tmux.sh', web_mix88_qlora_gitlabcoverage_warmupoversample_yearproducttiefix_adminoversample_tmux)
        ...
        self.assertIn('RUN_OUT_DIR="${RUN_OUT_DIR:-$WORKSPACE_ROOT/outputs/qwen_web_mix91_curriculum_v3_qlora_gitlabcoverage_warmupoversample_yearfix}"', web_mix91_qlora_gitlabcoverage_warmupoversample_yearfix_tmux)
        self.assertIn('TMUX_SESSION_NAME="${TMUX_SESSION_NAME:-qwen_web_mix91_v3_qlora_gitlabcoverage_warmupoversample_yearfix}"', web_mix91_qlora_gitlabcoverage_warmupoversample_yearfix_tmux)
        self.assertIn('run_qwen_web_mix91_curriculum_qlora_gitlabcoverage_warmupoversample_tmux.sh', web_mix91_qlora_gitlabcoverage_warmupoversample_yearfix_tmux)

        self.assertIn('RUN_OUT_DIR="${RUN_OUT_DIR:-$WORKSPACE_ROOT/outputs/qwen_web_mix91_curriculum_v4_qlora_gitlabcoverage_warmupoversample_yearproducttiefix}"', web_mix91_qlora_gitlabcoverage_warmupoversample_yearproducttiefix_tmux)
        self.assertIn('TMUX_SESSION_NAME="${TMUX_SESSION_NAME:-qwen_web_mix91_v4_qlora_gitlabcoverage_warmupoversample_yearproducttiefix}"', web_mix91_qlora_gitlabcoverage_warmupoversample_yearproducttiefix_tmux)
        self.assertIn('run_qwen_web_mix91_curriculum_qlora_gitlabcoverage_warmupoversample_tmux.sh', web_mix91_qlora_gitlabcoverage_warmupoversample_yearproducttiefix_tmux)

        self.assertIn('RUN_OUT_DIR="${RUN_OUT_DIR:-$WORKSPACE_ROOT/outputs/qwen_web_mix91_curriculum_v5_qlora_gitlabcoverage_warmupoversample_yearproducttiefix_adminoversample}"', web_mix91_qlora_gitlabcoverage_warmupoversample_yearproducttiefix_adminoversample_tmux)
        self.assertIn('TMUX_SESSION_NAME="${TMUX_SESSION_NAME:-qwen_web_mix91_v5_qlora_gitlabcoverage_warmupoversample_yearproducttiefix_adminoversample}"', web_mix91_qlora_gitlabcoverage_warmupoversample_yearproducttiefix_adminoversample_tmux)
        self.assertIn('--warmup-demo-task-group-episodes site_shopping_admin=4', web_mix91_qlora_gitlabcoverage_warmupoversample_yearproducttiefix_adminoversample_tmux)
        self.assertIn('--warmup-demo-task-group-limit-per-task site_shopping_admin=4', web_mix91_qlora_gitlabcoverage_warmupoversample_yearproducttiefix_adminoversample_tmux)
        self.assertIn('--warmup-task-group-sample-multiplier site_shopping_admin=2.0', web_mix91_qlora_gitlabcoverage_warmupoversample_yearproducttiefix_adminoversample_tmux)
        self.assertIn('run_qwen_web_mix91_curriculum_qlora_gitlabcoverage_warmupoversample_yearproducttiefix_tmux.sh', web_mix91_qlora_gitlabcoverage_warmupoversample_yearproducttiefix_adminoversample_tmux)
    ...
    def test_bootstrap44_current_stack_validation_wrappers_use_checked_in_scorecard(self) -> None:
        bash_script = _read_local_script("validate_bootstrap44_current_stack_scorecard.sh")
        powershell_script = _read_local_script("validate_bootstrap44_current_stack_scorecard.ps1")
    ...
    def test_bootstrap41_blocker_audit_wrappers_use_checked_in_manifest(self) -> None:
        ...
        powershell_script = _read_local_script("refresh_bootstrap41_blocker_audit.ps1")
    ...
    def test_web_mix91_current_stack_validation_wrappers_use_checked_in_scorecard(self) -> None:
        bash_script = _read_local_script("validate_web_mix91_current_stack_scorecard.sh")
        powershell_script = _read_local_script("validate_web_mix91_current_stack_scorecard.ps1")
    ...
    def test_web_mix88_current_stack_validation_wrappers_use_checked_in_scorecard(self) -> None:
        bash_script = _read_local_script("validate_web_mix88_current_stack_scorecard.sh")
        powershell_script = _read_local_script("validate_web_mix88_current_stack_scorecard.ps1")
