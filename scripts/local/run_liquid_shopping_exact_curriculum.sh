...
OUT_DIR="$WORKSPACE_ROOT/outputs/liquid_shopping_exact_curriculum_v1"
MANIFEST_PATH="$REPO_ROOT/scripts/local/shopping_exact_curriculum_manifest.json"
