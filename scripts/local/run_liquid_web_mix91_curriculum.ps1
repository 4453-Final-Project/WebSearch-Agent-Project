...
$outDir = Join-Path $workspaceRoot "outputs\liquid_web_mix91_curriculum_v1"
$localManifestPath = Join-Path $repoRoot "scripts\local\web_mix91_curriculum_manifest.json"
