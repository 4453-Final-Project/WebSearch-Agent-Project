...
OUT_DIR="${RUN_OUT_DIR:-$WORKSPACE_ROOT/outputs/qwen_shopping_order_curriculum_v1_qlora}"
SESSION_NAME="${TMUX_SESSION_NAME:-qwen_shopping_order_v1_qlora}"
LOCAL_MANIFEST_PATH="$REPO_ROOT/scripts/local/shopping_order_curriculum_manifest.json"
