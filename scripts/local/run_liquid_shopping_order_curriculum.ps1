...
$outDir = Join-Path $workspaceRoot "outputs\liquid_shopping_order_curriculum_v1"
$localManifestPath = Join-Path $repoRoot "scripts\local\shopping_order_curriculum_manifest.json"
