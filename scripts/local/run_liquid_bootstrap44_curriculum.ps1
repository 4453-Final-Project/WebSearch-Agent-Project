...
$outDir = Join-Path $workspaceRoot "outputs\liquid_bootstrap44_curriculum_v1"
$localManifestPath = Join-Path $repoRoot "scripts\local\bootstrap44_curriculum_manifest.json"
