...
export RUN_OUT_DIR="${RUN_OUT_DIR:-$WORKSPACE_ROOT/outputs/qwen_web_mix88_curriculum_v2_qlora_gitlabcoverage}"
export TMUX_SESSION_NAME="${TMUX_SESSION_NAME:-qwen_web_mix88_v2_qlora_gitlabcoverage}"
EXTRA_ARGS=(
...
exec bash "$SCRIPT_DIR/run_qwen_web_mix88_curriculum_qlora_tmux.sh"
