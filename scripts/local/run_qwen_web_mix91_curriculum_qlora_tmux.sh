...
OUT_DIR="${RUN_OUT_DIR:-$WORKSPACE_ROOT/outputs/qwen_web_mix91_curriculum_v1_qlora}"
SESSION_NAME="${TMUX_SESSION_NAME:-qwen_web_mix91_v1_qlora}"
LOCAL_MANIFEST_PATH="$REPO_ROOT/scripts/local/web_mix91_curriculum_manifest.json"
