...
- merged bootstrap current-stack summary in `outputs/bootstrap41_current_stack_summary.json`: the `bootstrap41` baseline from `outputs/qwen_bootstrap41_curriculum_v3_mapfix/baseline_eval_summary.json` now improves from `12/41` (`0.2926829268292683`) to `25/41` (`0.6097560975609756`) after folding in targeted re-evals for tasks `0`, `3`, `11`, `21`, `27`, `41`, `77`, `132`, `134`, `135`, `136`, `259`, and `293`
