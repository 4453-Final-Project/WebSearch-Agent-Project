...
- merged bootstrap current-stack summary in `outputs/bootstrap41_current_stack_summary.json`: the `bootstrap41` baseline from `outputs/qwen_bootstrap41_curriculum_v3_mapfix/baseline_eval_summary.json` now improves from `12/41` (`0.2926829268292683`) to `28/41` (`0.6829268292682927`) after folding in targeted re-evals for tasks `0`, `3`, `11`, `21`, `23`, `25`, `26`, `27`, `41`, `77`, `132`, `134`, `135`, `136`, `259`, and `293`
...
- the current quantized step-weight comparison rerun to watch is `outputs/qwen_bootstrap41_curriculum_v10_qlora_stepweight_searchtermfix/`, relaunched on the same checked-in `bootstrap41` split and `bnb_4bit` step-weight recipe so the current bootstrap training comparison includes the task-`41` fix from the start
