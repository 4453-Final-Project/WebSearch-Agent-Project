...
- merged bootstrap current-stack artifact: `outputs/bootstrap41_current_stack_summary.json` now moves the cross-site baseline from `12/41` (`0.2926829268292683`) to `23/41` (`0.5609756097560976`) after folding in targeted fixes for tasks `0`, `3`, `11`, `21`, `27`, `132`, `134`, `135`, `136`, `259`, and `293`
...
- current quantized step-weight comparison rerun to watch: `outputs/qwen_bootstrap41_curriculum_v10_qlora_stepweight_searchtermfix/`, which reuses the same checked-in `bootstrap41` split and `bnb_4bit` step-weight recipe while including the task-`41` popularity-based search-term extraction fix from the start
