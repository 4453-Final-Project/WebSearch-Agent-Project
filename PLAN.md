...
- merged bootstrap current-stack artifact: `outputs/bootstrap41_current_stack_summary.json` now moves the cross-site baseline from `12/41` (`0.2926829268292683`) to `28/41` (`0.6829268292682927`) after folding in targeted fixes for tasks `0`, `3`, `11`, `21`, `23`, `25`, `26`, `27`, `41`, `77`, `132`, `134`, `135`, `136`, `259`, and `293`
