...
- merged bootstrap current-stack artifact: `outputs/bootstrap41_current_stack_summary.json` now moves the cross-site baseline from `12/41` (`0.2926829268292683`) to `36/41` (`0.8780487804878049`) after folding in targeted fixes for tasks `0`, `3`, `11`, `21`, `23`, `25`, `26`, `27`, `28`, `30`, `31`, `41`, `66`, `67`, `68`, `69`, `77`, `126`, `132`, `134`, `135`, `136`, `259`, and `293`
...
- current bootstrap storefront price-range note: task `126` now has a clean focused re-eval win through the direct catalog-search price-range path, while tasks `124` and `125` now return grounded first-page catalog ranges that still disagree with the baked references
