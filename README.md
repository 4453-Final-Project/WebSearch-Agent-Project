...
- merged cross-site bootstrap current-stack artifact in `outputs/bootstrap41_current_stack_summary.json`: the `bootstrap41` baseline from `outputs/qwen_bootstrap41_curriculum_v3_mapfix/baseline_eval_summary.json` now rises from `12/41` to `37/41` after folding in targeted fixes for shopping-admin tasks `0`, `3`, `11`, `41`, and `77`, storefront tasks `21`, `23`, `25`, `26`, `125`, and `126`, Reddit tasks `27`, `28`, `30`, `31`, `66`, `67`, `68`, and `69`, and GitLab tasks `132`, `134`, `135`, `136`, `259`, and `293`
...
- current bootstrap storefront price-range note: task `125` is now validated at `1.0` in `outputs/eval_task_125_pricerangefix_v3/` after the catalog path started scanning sorted search pages for the first strongly query-matched extrema, task `126` remains green in `outputs/eval_task_126_pricerangefix_v1/`, and task `124` still returns a grounded but benchmark-misaligned range
